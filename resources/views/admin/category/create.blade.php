                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group bmd-form-group">
                                        ...
                                        <input type="text" name="name" id="ssname" value="{{ old('name') }}" class="form-control">
                                        <input type="hidden" name="type" value="category">
                                    </div>  
                                </div> 
                            <input type="hidden" name="slug" value="{{ old('slug') }}" readonly="readonly" id="slug" required="required" class="form-control">
                            ...
                            <div class="row">
                                <div class="col-md-6 mt-2">
                                    <div class="form-group bmd-form-group">
                                        ...
                                        <br>
                                        <input type="radio" name="parent_type" @if(old('parent_type') == "Yes") checked="checked" @endif value="Yes" onchange="myFunction()" ><span>Yes</span><br>
                                        <input type="radio" name="parent_type" @if(old('parent_type') == "No" || old('parent_type') == '') checked="checked" @endif value="No" onchange="myFunction()" ><span>No</span>
                                    </div>
                                </div>
                                 <div class="col-md-6" id="myDIV" style="display: none;">
                                    <select class="form-control" name="parent">
                                        ...
                                        @foreach(app('App\Term')->orderBy('id')->where('parent', null)->where('type','category')->where('status', '=', 'Active')->get() as $model)
                                            <option @if(old('parent') == $model->id) selected="selected" @endif value="{{ $model->id }}">{{ $model->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group bmd-form-group">
                                        ...
                                        <textarea type="text" name="description" required="required" class="form-control">{{ old('description') }}</textarea>
                                    </div>
                                </div>
                            </div>
